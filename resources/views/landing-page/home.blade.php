...
<head>
    ...
    <title>Milfolio - Personal Portfolio Kamil</title>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="{{route('home')}}">
                                        <svg class="nav-icon" viewBox="0 0 15 15" fill="none"
                                            ...
                                            <path d="M10.9753 10.1665C9.13359 11.2773 6.14859 11.2773 4.30859 10.1665"
                                                stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                        <span>Home</span>
                                    </a>
                            ...
                            <div class="card profile-card">
                                <div class="card-body">
                                    <div class="image text-center">
                                        <img src="{{asset("assets/img/images/KamilProfile.png")}}" alt="profile">
                                    </div>
                                    <div class="text">
                                        <h3 class="card-title">Rizky Kamil 👋</h3>
                                        <p>A Passionate <span>Web Developer</span> 🖥️ & <span>BackEnd Developer</span> having
                                            <span>4 years</span> of Experiences over 10+ Projects.</p>
                                        <div class="common-button-groups">
                                            <a class="btn btn-call" href="https://wa.me/+6285172014124" target="_blank">
                                            ...
                                            <button class="btn btn-copy" data-clipboard-text="rabbaniikamil@gmail.com">
                                        ...
                                        <div class="social-media-icon">
                                            <ul class="list-unstyled">
                                                <li><a href="https://www.instagram.com/kamilrzky_/" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                                <li><a href="https://wa.me/+6285172014124" target="_blank"><i class="fab fa-whatsapp"></i></a></li>
                                                <li><a href="https://github.com/rizkykamil" target="_blank"><i class="fab fa-github"></i></a></li>
                                                <li><a href="https://www.linkedin.com/in/rizky-kamil-rabbani/" target="_blank"><i class="fab fa-linkedin"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="work-experiance-main">
                                                <ul class="work-experiance-slider list-unstyled">
                                                    <li>
                                                        ...
                                                        <div class="info">
                                                            <div class="icon">
                                                                <img src="https://wibidigital.com/assets/img/favicon.png" alt="adobe">
                                                            </div>
                                                            <div class="text">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="info">
                                                            <div class="icon">
                                                                <img src="https://crm.hepta.co.id/assets/img/fav-icon.png" alt="google">
                                                            </div>
                                                            <div class="text">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="info">
                                                            <div class="icon">
                                                                <img src="https://www.inti.co.id/wp-content/uploads/2020/03/Logo-INTI_a.svg" alt="meta">
                                                            </div>
                                                            <div class="text">
                                            ...
                                            <div class="expertise-main mt-24">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                                                        <div class="expertise-item">
                                                            <div class="image text-center">
                                                                <img src="{{asset("assets/img/icons/notion.svg")}}" alt="notion">
                                                            </div>
                                                            <div class="text">
                                                    ...
                                                    <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                                                        <div class="expertise-item">
                                                            <div class="image text-center">
                                                                <img src="https://upload.wikimedia.org/wikipedia/en/thumb/d/dd/MySQL_logo.svg/150px-MySQL_logo.svg.png" alt="micro">
                                                            </div>
                                                            <div class="text">
                                                    ...
                                                    <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                                                        <div class="expertise-item">
                                                            <div class="image text-center">
                                                                <img src="{{asset("assets/img/icons/github.svg")}}" alt="github">
                                                            </div>
                                                            <div class="text">
                                                    ...
                                                    <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                                                        <div class="expertise-item">
                                                            <div class="image text-center">
                                                                <img src="https://github.githubassets.com/assets/actions-icon-actions-61925a4b8822.svg" alt="zeplin">
                                                            </div>
                                                            <div class="text">
                                                ...
                                                <div class="project-item">
                                                    <div class="image">
                                                        ...
                                                        <a href="https://flozorsgym.com/" target="_blank"
                                                            ...
                                                            <svg class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                                            ...
                                            <div class="row g-4 justify-content-center align-items-center">
                                                <div class="col-md-3 col-sm-6 col-6">
                                                    <div class="services-item text-center">
                                                        <div class="image">
                                                            <img src="{{asset("assets/img/icons/prd-design.svg")}}" alt="prd-design">
                                                        </div>
                                                        <div class="text">
                                                ...
                                                <div class="col-md-3 col-sm-6 col-6">
                                                    <div class="services-item text-center">
                                                        <div class="image">
                                                            <img src="{{asset("assets/img/icons/branding.svg")}}" alt="branding">
                                                        </div>
                                                        <div class="text">
                                                ...
                                                <div class="col-md-3 col-sm-6 col-6">
                                                    <div class="services-item text-center">
                                                        <div class="image">
                                                            <img src="{{asset("assets/img/icons/web-development.svg")}}" alt="Web Development">
                                                        </div>
                                                        <div class="text">
                                ...
                                <div class="card lets-talk-together-card">
                                    <div class="card-body">
                                        ...
                                        <a class="link-btn" href="contact.html"> Let's Talk
                                            <svg class="icon" width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path d="M17.5 11.6665V6.6665H12.5" stroke-width="1.5"
                                                    stroke-linecap="round" stroke-linejoin="round" />
        ...
        <footer class="footer-area">
            <div class="container">
                <div class="text text-center">
                    <p>© {{date('Y')}} Rizky Kamil. All Rights Reserved.</p>
                </div>
            </div>
        </footer>
        <!-- footer part end -->
